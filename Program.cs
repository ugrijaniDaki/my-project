...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!db.MenuItems.Any())
    {
        ...
        {
            // Predjela (Appetizers)
            new MenuItem { Name = "Carpaccio od tune", Description = "Svježa tuna s rukolom, kaparima i parmezanom", Price = 14.90m, Category = MenuCategory.Appetizer, IsAvailable = true, IsGlutenFree = true, SortOrder = 1, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Bruschetta", Description = "Hrskavi kruh s cherry rajčicama, bosiljkom i balzamiko kremom", Price = 8.90m, Category = MenuCategory.Appetizer, IsAvailable = true, IsVegetarian = true, IsVegan = true, SortOrder = 2, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Pršut i sir", Description = "Dalmatinski pršut s domaćim sirom i maslinama", Price = 12.90m, Category = MenuCategory.Appetizer, IsAvailable = true, IsGlutenFree = true, SortOrder = 3, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Tartar od lososa", Description = "Svježi losos s avokadom i sezamom", Price = 15.90m, Category = MenuCategory.Appetizer, IsAvailable = true, IsGlutenFree = true, SortOrder = 4, CreatedAt = DateTime.UtcNow },

            // Juhe (Soups)
            new MenuItem { Name = "Juha od rajčice", Description = "Kremasta juha od pečenih rajčica s bosiljkom", Price = 6.90m, Category = MenuCategory.Soup, IsAvailable = true, IsVegetarian = true, IsVegan = true, IsGlutenFree = true, SortOrder = 1, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Riblja juha", Description = "Tradicionalna dalmatinska riblja juha", Price = 9.90m, Category = MenuCategory.Soup, IsAvailable = true, IsGlutenFree = true, SortOrder = 2, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Goveđa juha", Description = "Domaća goveđa juha s rezancima", Price = 7.90m, Category = MenuCategory.Soup, IsAvailable = true, SortOrder = 3, CreatedAt = DateTime.UtcNow },

            // Salate (Salads)
            new MenuItem { Name = "Cezar salata", Description = "Romanska salata, piletina, parmezan, krutonsi i Cezar dressing", Price = 11.90m, Category = MenuCategory.Salad, IsAvailable = true, SortOrder = 1, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Grčka salata", Description = "Rajčice, krastavci, paprika, luk, masline i feta sir", Price = 9.90m, Category = MenuCategory.Salad, IsAvailable = true, IsVegetarian = true, IsGlutenFree = true, SortOrder = 2, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Salata s kozjim sirom", Description = "Mješana salata s toplim kozjim sirom i orasima", Price = 12.90m, Category = MenuCategory.Salad, IsAvailable = true, IsVegetarian = true, IsGlutenFree = true, SortOrder = 3, CreatedAt = DateTime.UtcNow },

            // Tjestenina (Pasta)
            new MenuItem { Name = "Spaghetti Carbonara", Description = "Spaghetti s guanciale, jajima i pecorino sirom", Price = 13.90m, Category = MenuCategory.Pasta, IsAvailable = true, SortOrder = 1, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Penne Arrabiata", Description = "Penne s ljutim umakom od rajčice", Price = 11.90m, Category = MenuCategory.Pasta, IsAvailable = true, IsVegetarian = true, IsVegan = true, SortOrder = 2, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Crni rižot", Description = "Rižot s tintom od sipe i plodovima mora", Price = 16.90m, Category = MenuCategory.Pasta, IsAvailable = true, IsGlutenFree = true, SortOrder = 3, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Tagliatelle s tartufima", Description = "Domaća tjestenina s crnim tartufima", Price = 22.90m, Category = MenuCategory.Pasta, IsAvailable = true, IsVegetarian = true, SortOrder = 4, CreatedAt = DateTime.UtcNow },

            // Ribe (Fish)
            new MenuItem { Name = "Brancin na žaru", Description = "Svježi brancin s povrćem na žaru i blitvom", Price = 24.90m, Category = MenuCategory.Fish, IsAvailable = true, IsGlutenFree = true, SortOrder = 1, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Hobotnica ispod peke", Description = "Hobotnica s krumpirom ispod peke", Price = 26.90m, Category = MenuCategory.Fish, IsAvailable = true, IsGlutenFree = true, SortOrder = 2, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Škampi na buzaru", Description = "Škampi u umaku od bijelog vina i češnjaka", Price = 28.90m, Category = MenuCategory.Fish, IsAvailable = true, SortOrder = 3, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Tuna steak", Description = "Tuna steak srednje pečena s wakame salatom", Price = 27.90m, Category = MenuCategory.Fish, IsAvailable = true, IsGlutenFree = true, SortOrder = 4, CreatedAt = DateTime.UtcNow },

            // Meso (Meat)
            new MenuItem { Name = "Biftek na žaru", Description = "300g biftek s pečenim povrćem i umakom od vina", Price = 32.90m, Category = MenuCategory.Meat, IsAvailable = true, IsGlutenFree = true, SortOrder = 1, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Janjetina ispod peke", Description = "Janjetina s krumpirom ispod peke", Price = 28.90m, Category = MenuCategory.Meat, IsAvailable = true, IsGlutenFree = true, SortOrder = 2, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Pureći odrezak", Description = "Pureći odrezak s pireom i umakom od gljiva", Price = 18.90m, Category = MenuCategory.Meat, IsAvailable = true, IsGlutenFree = true, SortOrder = 3, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Ćevapi", Description = "10 ćevapa s lepinjom, lukom i kajmakom", Price = 14.90m, Category = MenuCategory.Meat, IsAvailable = true, SortOrder = 4, CreatedAt = DateTime.UtcNow },

            // Deserti (Desserts)
            new MenuItem { Name = "Tiramisu", Description = "Klasični talijanski desert s espressom i mascarponeom", Price = 7.90m, Category = MenuCategory.Dessert, IsAvailable = true, IsVegetarian = true, SortOrder = 1, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Panna cotta", Description = "Talijanski kremasti desert s voćnim umakom", Price = 6.90m, Category = MenuCategory.Dessert, IsAvailable = true, IsVegetarian = true, IsGlutenFree = true, SortOrder = 2, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Čokoladni lava cake", Description = "Topli čokoladni kolač s tekućom jezgrom", Price = 8.90m, Category = MenuCategory.Dessert, IsAvailable = true, IsVegetarian = true, SortOrder = 3, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Voćna salata", Description = "Svježe sezonsko voće s mentom", Price = 5.90m, Category = MenuCategory.Dessert, IsAvailable = true, IsVegetarian = true, IsVegan = true, IsGlutenFree = true, SortOrder = 4, CreatedAt = DateTime.UtcNow },

            // Pića (Beverages)
            new MenuItem { Name = "Espresso", Description = "Talijanska kava", Price = 2.50m, Category = MenuCategory.Beverage, IsAvailable = true, IsVegan = true, IsGlutenFree = true, SortOrder = 1, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Cappuccino", Description = "Espresso s mlijekom i mliječnom pjenom", Price = 3.50m, Category = MenuCategory.Beverage, IsAvailable = true, IsVegetarian = true, IsGlutenFree = true, SortOrder = 2, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Svježe cijeđeni sok", Description = "Naranča, jabuka ili grejp", Price = 4.50m, Category = MenuCategory.Beverage, IsAvailable = true, IsVegan = true, IsGlutenFree = true, SortOrder = 3, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Mineralna voda", Description = "0.75l", Price = 3.00m, Category = MenuCategory.Beverage, IsAvailable = true, IsVegan = true, IsGlutenFree = true, SortOrder = 4, CreatedAt = DateTime.UtcNow },
            new MenuItem { Name = "Domaća limunada", Description = "Svježa limunada s mentom", Price = 4.00m, Category = MenuCategory.Beverage, IsAvailable = true, IsVegan = true, IsGlutenFree = true, SortOrder = 5, CreatedAt = DateTime.UtcNow },

            // Specijaliteti dana (Daily Specials)
            new MenuItem { Name = "Specijalitet dana", Description = "Pitajte konobara za današnji specijalitet", Price = 19.90m, Category = MenuCategory.Special, IsAvailable = true, SortOrder = 1, CreatedAt = DateTime.UtcNow }
        };
